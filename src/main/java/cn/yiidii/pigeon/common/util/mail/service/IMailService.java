...
public interface IMailService {
     ...
     * @param mimeMessageHelper：二进制文件的包装类
     */
    void handleBasicInfo(MimeMessageHelper mimeMessageHelper, String subject, String content, String[] toWho, String templateName, Object model);
